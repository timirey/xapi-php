...
class SymbolRecord
{
     ...
     * @param integer      $stopsLevel         Min distance (in pips) from the current price where the sl/tp can be set.
     ...
     * @param boolean      $trailingEnabled    Indicates whether trailing stop (offset) is applicable to the instrument.
